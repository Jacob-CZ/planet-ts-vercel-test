...
export default function Home() {
	...
	const tryAdress = async (adress: string) => {
		...
		fetch(
			`https://api.geoapify.com/v1/geocode/autocomplete?text=${adress}&apiKey=ad212d62c2094206a8b5d8da0e586442`,
			requestOptions
		)
	...
	return (
		<main className="grid gap-4 p-5">
			...
			<Link href="/admin/vedas" className="w-fit">
				<Button>edit vedas</Button>
			</Link>
			<Link href="/vedas" className="w-fit">
				<Button>Vedas</Button>
			</Link>
			...
			<Link href="/admin/products" className="w-fit">

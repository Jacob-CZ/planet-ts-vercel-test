...
import Model from "@/components/3d_components/PillBottle3.jsx";
import { use, useEffect, useRef, useState } from "react";
import styles from "@/src/app/store/page.module.css";
import ProductPage from "@/components/3d_components/productPage";
...
export default function Home() {
  ...
  useEffect(() => {
    if (isHovered) {
      ...
      contRef.current!.style.overflow = "auto";
    }
  }
  , [isHovered]);

  return (
    <div ref={contRef} className="w-screen h-screen fixed overflow-y-auto">
